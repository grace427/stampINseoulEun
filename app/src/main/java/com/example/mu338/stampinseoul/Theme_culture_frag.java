...
public class Theme_culture_frag extends Fragment {
    ...
    public Theme_culture_frag() {
        // Required empty public constructor
    }

    //뷰페이저로 프레그먼트가 변화되는 상태를 저장하는 변수가 필요하다.
    public  static Theme_culture_frag newInstance(){
        Theme_culture_frag culture_frag = new Theme_culture_frag();
        return culture_frag;
    }
    @Nullable
    @Override
    ...
    class AsyncTaskClassSub extends android.os.AsyncTask<Integer, ThemeData, String> {
